...
_BUILTIN_DEFINITIONS: list[dict] = [
    ...
    },
    {
        ...
        "label": "本地微软邮箱池",
        "description": "导入 Hotmail/Outlook 邮箱池，支持 GuJumpgate 四列格式；Outlook/Hotmail/Live/MSN 每个真实邮箱会自动扩展原邮箱 +1~+4 共 5 个注册槽位",
        ...
        "fields": [
            {
                ...
                "category": "connection",
                "hint": "可选；每行一条 Hotmail 四列格式：账号----密码----ID----Token。Outlook/Hotmail/Live/MSN 会自动使用 +1~+4 别名扩展槽位。",
            },
            {
                ...
                "type": "textarea",
                "category": "auth",
                "hint": "可选；直接粘贴 Hotmail 四列格式：账号----密码----ID----Token。Outlook/Hotmail/Live/MSN 会自动使用 +1~+4 别名扩展槽位。",
            },
            {
